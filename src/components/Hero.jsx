      ...
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
            Best Crypto  <br className="sm:block hidden"/> {" "}
        ...
        <h1  className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full"> Join now!</h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts uses a methodology
          to identify the market and provide you with the best signals.
        </p>
      </div>


      <div className={`flex-1 flex ${styles.flexCenter} md:mr-0  my-10 relative`}>
        <img src={crypto} className="w-[100%] h-[100%] relative z-[5]" alt="" srcset="" />
